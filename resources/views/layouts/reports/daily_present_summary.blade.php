                        ...
                        <div class="white_card_body">
                            <div class="QA_section">
                                <div class="white_box_tittle list_header">
                                    <h4 class="text-center">Daily Present Summary</h4>
                                </div>

                                <div class="col-md-12 float-left">

                                    <form action="{{ url('daily-present-summary') }}" method="POST">
                                        @csrf
                                        <div class="form-row align-items-center">
                                            ...
                                            <div class="col-auto my-1">
                                                ...
                                                <a href="daily-present-summary-pdf" class="btn btn-outline-info btn-sm"><i class="fas fa-file-pdf"></i> PDF</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                                        ...
                                        <table class="table lms_table_active ">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><span class="status_btn">{{ $data['marking'] }}</span></td>
                                                    {{-- <td>
