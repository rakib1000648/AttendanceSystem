                    ...
                    <div class="white_card_header">
                        <div class="box_header m-0">
                            <div class="main-title">
                                <h3 class="m-0">Edit Employee leave</h3>
                            </div>
                        </div>
                    </div>
                    <div class="white_card_body">

                        <form action="{{ url('edit-leave') }}" method="POST">
                            @method('PUT')
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select id="user_id" class="form-control" name="user_id">
                                    ...
                                    <option value="{{ $d->dev_emp_id }}" @if ($data->user_id ==  $d->dev_emp_id)
                                        Selected
                                    @endif>{{ $d->name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select id="leave_type_id" class="form-control" name="leave_type_id">
                                    ...
                                    <option value="{{ $d->id }}" @if ($data->leave_type_id ==  $d->id)
                                        Selected
                                    @endif>{{ $d->type }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group mb-0">
                                        <input type="date" class="form-control" value="{{ $data->leave_start_date }}" name="leave_start_date" id="sdate">
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group mb-0">
                                        <input type="date" class="form-control" value="{{ $data->leave_end_date }}" name="leave_end_date" id="edate">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="leave_cause" class="form-control" cols="30" rows="2" placeholder="Write here...">{{ $data->leave_cause }}</textarea>
