                    ...
                    <div class="white_card_header">
                        <div class="box_header m-0">
                            <div class="main-title">
                                <h3 class="m-0">Create Shift</h3>
                            </div>
                        </div>
                    </div>
                    <div class="white_card_body">

                        <form action="{{ url('create-shift') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group mb-0">
                                        <input type="time" class="form-control" name="start_time" id="stime">
                                    </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="form-group mb-0">
                                        <input type="time" class="form-control" name="end_time" id="etime">
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-0">
                                    <input type="time" class="form-control" value="" name="grace_time" id="Gracetime">
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group mb-0">
                                    <input type="time" class="form-control" value="" name="absent_time" id="absent_time">
                                </div>
