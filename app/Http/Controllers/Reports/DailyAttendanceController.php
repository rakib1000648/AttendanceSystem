...
class DailyAttendanceController extends Controller
{
    public function index()
    {
        ...
        return view('layouts.reports.daily_attendance_summary',compact('results'));
    }
    ...
    public function DateWise(Request $request)
    {
        ...
        return view('layouts.reports.daily_attendance_summary',compact('results','fullDate'));
    }
    public function generatePDF()
    {
        ...
        $pdf = PDF::loadView('layouts.reports.pdf.daily_attendance_summary', $results);
        return $pdf->download($date.'_daily_attendance_summary.pdf');
    }
}
