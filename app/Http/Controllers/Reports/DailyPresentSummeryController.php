...
class DailyPresentSummeryController extends Controller
{
    public function index()
    {
        ...
        return view('layouts.reports.daily_present_summary',compact('results'));
    }
    ...
    public function DateWise(Request $request)
    {
        ...
        foreach ($userData as $user) {
            ...
            Session::forget('fullDate');
            Session::put('fullDate', $fullDate);
        return view('layouts.reports.daily_present_summary',compact('results','fullDate'));
    }
    public function generatePDF()
    {
        ...
        $pdf = PDF::loadView('layouts.reports.pdf.daily_present_summary', $results);
        return $pdf->download($date.'_daily_present_summary.pdf');
    }
}
